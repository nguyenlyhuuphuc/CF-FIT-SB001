                ...
                <div>
                    <form action="{{ route('admin.product.index') }}" method="GET" role="form">
                        <div class="form-group">
                            ...
                            <input name="keyword" type="text" class="form-control" id="keyword" placeholder="Enter keyword" value="{{ request()->keyword ?? '' }}">
                          ...
                          <div class="form-group">
                            ...
                            <select name="sort" class="form-control">
                              ...
                              <option {{ request()->sort === 'price_low_to_high' ? 'selected' : '' }} value="price_low_to_high">Price low to high</option>
                              <option {{ request()->sort === 'price_high_to_low' ? 'selected' : '' }} value="price_high_to_low">Price high to low</option>
                            </select>
                          </div>
